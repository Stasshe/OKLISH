...
ウィンドウは、画面上どこへでも動かせるフロート。（interact.jsを使う）

npmライブラリで、cdn読み込みさせようと思ってる。

indexeddbに、oklishで既存のセッション情報を含めておいたり。
あとは、ツールの拡張性も意識したい。
...
- **フローティングUI**: interact.jsによるドラッグ可能なウィンドウ
- **モダン設計**: React + TypeScript構成
- **CDN配信**: npm経由での簡単導入
- **拡張可能**: プラグインアーキテクチャ
- **永続化**: IndexedDBによるセッション管理(!important!)
...
```json
{
  "name": "oklish",
  "version": "1.0.0",
  "main": "dist/oklish.umd.js",
  "module": "dist/oklish.es.js",
  "types": "dist/types/index.d.ts",
  "files": ["dist"],
  "cdn": "dist/oklish.min.js"
}
```
